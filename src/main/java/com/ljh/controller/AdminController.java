...
public class AdminController {
	...
	public String postGoodsModify(GoodsVO vo, @RequestParam("n") int gdsNum, MultipartFile file, HttpServletRequest request) throws Exception{
